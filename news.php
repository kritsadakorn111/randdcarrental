...
<html lang="en">
  ...
  <body>
    ...
    <div class="featured container no-gutter">
          ...
          <div class="row posts">
          <?php
                $select_stmt = $db->prepare("SELECT * FROM tbl_news");
                $select_stmt->execute();
            ...
            <div id="<?php echo $row['id']; ?>" class="item new col-md-4">
              <a href="newss.php?id=<?php echo $row['id']; ?><?php //echo $row['news_link']; ?>">
                <div class="featured-item text-center">
                  <img src="images/<?php echo $row['news_img']; ?>" width="120px" height="100px" alt="">
                  <h4><?php echo $row["news_headline"] ?></h4>
